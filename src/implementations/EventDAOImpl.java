...
public class EventDAOImpl implements EventDAO {
    ...
    public void createEvent(Event event) throws SQLException {
        ...
        try (Connection conn = DBConnection.getConnection(); PreparedStatement stmt = conn.prepareStatement(sql)) {
            ...
            stmt.setString(4, event.getVeneu());
    ...
    public void updateEvent(Event event) throws SQLException {
        String sql = "UPDATE events SET eventName = ?, startTime = ?, endTime = ?, veneu = ?, description = ? WHERE geofenceId = ?";
        try (Connection conn = DBConnection.getConnection(); PreparedStatement stmt = conn.prepareStatement(sql)) {
            stmt.setString(1, event.getEventName());
            stmt.setString(2, event.getStartTime());
            stmt.setString(3, event.getEndTime());
    ...
    public void deleteEvent(int EventsId) throws SQLException {
